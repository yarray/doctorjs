...
Aobj.prototype.toArrayType = function(seenObjs) {
  ...
  this.forEachOwnProp(function(p) {
      if (propIsNumeric(p)) elmtype = avjoin(elmtype, self.getOwnProp(p));
    });
...
Aobj.prototype.forEachOwnProp = function(f) {
  for (var p in this)
    if (this[p] instanceof Aprop) f(p);
};
...
function getProp(o, prop, seenObjs) {
  if (o.hasOwnProperty(prop)) return o[prop].aval;
...
Aobj.prototype.getOwnProp = function(prop) {
  return this[prop] && this[prop].aval;
};

// string, Object -> undefined
// attribs.aval is the property's value
// attribs.enum is true iff the property is enumerable
...
// Considers only enumerable properties.
...
function forEachProp(o, f, seenObjs, seenProps) {
  for (var p in o)
    if ((o[p] instanceof Aprop) 
        && o[p].enum 
  ...
  o[0].forEachObj(function(proto) {
      forEachProp(proto, f, seenObjs, seenProps);
...
(function() {
  ...
  function _dot_proto(n, ans, oldlval) {
    ...
    ans2.v.forEachObj(function (o) {
        if (o.getFun() && !o.getOwnProp("prototype-"))
          o.addProp("prototype-", {aval : ans.v, enum : false});
        else
          o.updateProp("prototype-", ans.v);
      });
    ans.fr = ans2.fr;
    ans.err = maybeavjoin(ans.err, ans2.err);
    return ans;
