...
(function() {
  ...
  function _index(n, ans, oldlval) {
    ...
    if (pt === NUMBER)
      ...
      avobj.forEachObj(function(o) { o.updateProp(prop.value, rval); });
    else {
      ...
      if (avprop.hasStr()) {
        ...
        if (slit)
          avobj.forEachObj(function(o) { o.updateProp(slit, rval); });
        else
  ...
  function _dot(n, ans, oldlval) {
    ...
    ans2.v.forEachObj(function(o) { o.updateProp(n[1].name, ans.v); });
    ans.fr = ans2.fr;
...
(function() {
  ...
  function _index(n, fr) {
    ...
    // Unsound: ignore everything the index can eval to except numbers & strings
    if (pt === NUMBER)
      av = avobj.getProp(prop.value.toString() + "-");
    else if (pt === STRING)
