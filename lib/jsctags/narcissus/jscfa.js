...
function Aprop(attribs){
  ...
  // if enumerability not specified, default to true
...
function makeDefaultProto(n) {
  ...
  o["constructor-"] = new Aprop({aval : new Aval(NOBASEVALS, n.addr), 
                                 enum : false});
...
function initCoreObjs() {
  ...
  function attachMethod(o, mname, mcode, arity) {
    ...
    o.addProp(mname + "-", 
              {aval : new Aval(NOBASEVALS, foaddr), enum : false});
  }
  ...
  heap[++count] = AUNDEF;
  go.addProp("Infinity-", {aval : ANUM, enum : false});
  go.addProp("NaN-", {aval : ANUM, enum : false});
  go.addProp("undefined-", {aval : AUNDEF, enum : false});
  ...
  heap[fppaddr] = fpp;
  o_p.addProp("prototype-", {aval : fppav, enum : false});
  ...
  o.addProp("prototype-", {aval : opav, enum : false});
  ...
  f.addProp("prototype-", {aval : o_pav, enum : false});
  ...
  (function () {
    ...
    a.addProp("prototype-", {aval : apav, enum : false});
  ...
  (function () {
    ...
    n.addProp("prototype-", {aval : npav, enum : false});
  ...
  (function () {
    ...
    s.addProp("prototype-", {aval : spav, enum : false});
  ...
  (function () {
    ...
    e.addProp("prototype-", {aval : epav, enum : false});
    ep.addProp("constructor-", {aval : eav, enum : false});
    ep.addProp("name-", {aval : ASTR});
    ...
    se.addProp("prototype-", {aval : sepav, enum : false});
  ...
  (function () {
    ...
    function _RegExp(args) {
      args[0].forEachObj(function (o) {
          o.updateProto(rpav);
          o.addProp("global-", {aval : ABOOL, enum : false});
          o.addProp("ignoreCase-", {aval : ABOOL, enum : false});
          o.addProp("lastIndex-", {aval : ANUM, enum : false});
          o.addProp("multiline-", {aval : ABOOL, enum : false});
          o.addProp("source-", {aval : ASTR, enum : false});
        });
      return new Ans(args[0], undefined);
    }
    ...
    r.addProp("prototype-", {aval : rpav, enum : false});
  ...
  (function () {
    ...
    d.addProp("prototype-", {aval : dpav, enum : false});
  ...
  (function () {
    ...
    m.addProp("E-", {aval : ANUM, enum : false});
    m.addProp("LN10-", {aval : ANUM, enum : false});
    m.addProp("LN2-", {aval : ANUM, enum : false});
    m.addProp("LOG10E-", {aval : ANUM, enum : false});
    m.addProp("LOG2E-", {aval : ANUM, enum : false});
    m.addProp("PI-", {aval : ANUM, enum : false});
    m.addProp("SQRT1_2-", {aval : ANUM, enum : false});
    m.addProp("SQRT2-", {aval : ANUM, enum : false});
  ...
  (function () {
    ...
    b.addProp("prototype-", {aval : bpav, enum : false});
