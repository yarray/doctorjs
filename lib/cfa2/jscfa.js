...
function initDOMObjs() {
  ...
  // Possible improvement for web_developer: when pushing chrome (resp. content)
  // elms to an Array, make the type of that Array chrome (resp. content).
  //
  // var oldPush = array_prototype_aobj.getOwnProp("push-");
  // attachMethod(array_prototype_aobj, "push", function(args) {
  //   if (args[1] instanceof Chrome)
  //     return chrarrav
  // }, 0);
