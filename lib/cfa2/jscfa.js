...
(function () {
  ...
  // Array of id nodes, Array of id nodes, tokenizer -> Substitution map
  ...
  override(LET, function(n, scriptVds, innerBlock) {
    ...
    smap = tmp.smap;
    // Call subst on innerBlock.children directly, to avoid binding vars that
    // must be substituted.
    innerBlock.children.forEach(function(stm) { subst(stm, smap, []); });
    n.type = SEMICOLON;
    n.expression = tmp.comman;
    delete n.children;
  });
